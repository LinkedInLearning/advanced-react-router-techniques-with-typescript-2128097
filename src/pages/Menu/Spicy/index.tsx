    ...
    <Container>
      {loading ? (
        ...
        <>
          ...
          <RecipeList>
            <RecipeItem>
              <Link to="/menu/spicy/spicy-jollof">Spicy Jollof</Link>
            </RecipeItem>
            <RecipeItem>
              <Link to="/menu/spicy/chicken-pepper-soup">Chicken Pepper Soup</Link>
            </RecipeItem>
            <RecipeItem>
              <Link to="/menu/spicy/spicy-curry-sauce">Spicy Curry Sauce</Link>
            </RecipeItem>
          </RecipeList>
        </>
      )}
